...
show_pid "Vidu Live proxy" "$run_dir/vidu-live-proxy-${OPENTALKING_VIDU_PROXY_PORT:-18088}.pid"
check_url "Vidu Live proxy" "http://127.0.0.1:${OPENTALKING_VIDU_PROXY_PORT:-18088}/index.html"
