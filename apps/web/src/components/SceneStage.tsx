...
export function SceneStage({
  ...
  const avatarFit = videoFit === "cover" || scene?.avatar_fit === "cover" ? "object-cover" : "object-contain";
  ...
  const avatarMaskPosition = avatarAnchor === "bottom"
    ...
    : avatarAnchor === "left"
      ...
      : avatarAnchor === "right"
        ? "right center"
        : "center";
  const hasSceneBackground = Boolean(scene) || Boolean(backgroundColorOverride);
  const backgroundColor = backgroundColorOverride || scene?.background_color || "#ffffff";
