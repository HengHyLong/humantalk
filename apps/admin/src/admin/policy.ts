...
export const ROLE_PERMISSIONS: Record<AdminRole, PermissionCode[]> = {
  sys_admin: [
    ...
    "event:exhibit", "event:venue", "event:point", "event:route", "event:schedule", "event:broadcast", "event:import", "lead:view", "lead:view_sensitive", "lead:export", "lead:feedback", "report:interaction", "system:user", "system:role", "system:audit", "system:ops", "system:llm", "audit:trace", "ops:failover",
  ],
  content_ops: [
    "dashboard:view", "asset:avatar", "asset:gif", "asset:voice", "asset:scene", "asset:idle",
    "knowledge:document", "knowledge:base", "knowledge:memory", "knowledge:qa", "knowledge:script", "knowledge:publish", "interact:test",
    "interact:welcome", "interact:explain", "interact:shopping", "event:exhibition", "event:exhibitor",
    "event:exhibit", "event:venue", "event:point", "event:route", "event:schedule", "event:broadcast", "event:import", "lead:view", "lead:view_sensitive", "lead:export", "lead:feedback",
  ],
