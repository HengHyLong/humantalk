...
import { AuditLogPage, LlmConfigManagementPage, OpsMonitoringPage, PermissionManagementPage, RoleManagementPage, UserManagementPage } from "./SystemManagementPages";
import { DocumentCenterPage, KnowledgeBasePage, MemoryCenterPage } from "./KnowledgeCenterPages";
import { KnowledgePublishPage, KnowledgeQaPage, OfficialScriptPage } from "./KnowledgeWorkflowPages";
import {
  EnhancedAvatarPage,
  EnhancedGifPage,
  EnhancedIdlePage,
...
import { toLoginUiError, toUiError } from "./errors";
...
const MENU_GROUPS: MenuItem[] = [
  ...
  { id: "system", label: "系统管理", children: [
    ...
    { id: "system-permission", label: "权限管理", path: "/system/permission", permission: "system:role" },
