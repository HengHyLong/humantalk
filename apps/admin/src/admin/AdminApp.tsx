...
export function AdminApp() {
  ...
  const logout = () => { void adminApi.logout().catch(() => undefined); window.localStorage.removeItem("opentalking-admin-session"); window.localStorage.removeItem("opentalking-admin-token"); setUser(null); };
