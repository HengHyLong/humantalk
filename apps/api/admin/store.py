...
class AdminStore:
    ...
    def _seed_records(conn: sqlite3.Connection, now: str) -> None:
        records = [
            ...
            ("runtime_configs", "expo-2026", "expo-2026", {"id": "expo-2026", "exhibitionId": "expo-2026", "keywords": {"navigation": ["怎么去", "在哪里", "路线"], "exhibition_content": ["展会介绍", "展商信息", "展品介绍"], "shopping": ["推荐", "对比", "导购", "适合我"]}, "supports_deferred_speak": True}),
        ...
        records.extend([
            ...
            ("runtime_configs", "expo-2027", "expo-2027", {"id": "expo-2027", "exhibitionId": "expo-2027", "keywords": {"navigation": ["怎么去论坛", "在哪里签到"], "exhibition_content": ["智慧城市", "绿色交通"], "shopping": ["推荐", "对比", "方案"]}, "supports_deferred_speak": True}),
